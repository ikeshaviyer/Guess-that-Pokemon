...
def main_game():
    ...
    time_limit = 30  # 30 seconds limit for the entire game
    ...
    while running:
        ...
        # Display points and remaining time
        ...
        screen.blit(timer_surface, (bg_width - 200, 50))
            ...
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_RETURN:
                    if user_text.lower() == pokemon_name:
                        ...
                        pokemon_img = fetch_pokemon_image(pokemon_img_url)
                        silhouette = create_silhouette(pokemon_img)
                        user_text = ""  # Reset user input after correct guess
                    else:
                        incorrect_sound.play()  # Play incorrect sound
                        send_high()
                        user_text = ""  # Reset user input after incorrect guess
